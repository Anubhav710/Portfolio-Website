...
const About = () => {
  return (
    <div className="Wrapper Div px-2 md:px-5">
      ...
      >
        👋 Hi, I&pos;m Anubhav Agrawal! I&pos;m a friendly web developer hailing
        from Gurugram, Haryana. Currently pursuing my B.Tech degree from
        ...
        experiences. Let&pos;s collaborate and bring your web projects to life!
        Connect with me today and let&pos;s make magic happen. ✨💻
      </motion.p>
